...
export default function Index() {
  ...
  useEffect(() => {
    ...
    if (state === "extracting") {
      ...
      sendMessage("Extract the relevant information for symptom detection in the following text: " + latestAssistantChat, chatHistory);
    } else if (state === "confirming") {
      const secondLatestAssistantChat = chatHistory.filter(obj => obj.role === "assistant").slice(-1)[1];
      sendMessage("Output 'true' or 'false' without dot, is there any relevant information for symptom detection in this text: " + secondLatestAssistantChat, chatHistory);
